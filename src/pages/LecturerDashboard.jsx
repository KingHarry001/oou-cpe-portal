...
import {
  ...
  IconMessageCircle, IconFiles, IconLogout,
...
export default function LecturerDashboard() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-white">
      <MobileNav tabs={TABS} active={active} setActive={setActive} profile={profile} portalLabel="Lecturer portal" />
      ...
      <main className="flex-1 w-full px-4 sm:px-6 md:px-12 py-6 sm:py-10 max-w-5xl">
        <header className="hidden lg:flex items-center justify-between mb-10">
          <h1 className="text-2xl font-medium">Lecturer Dashboard</h1>
        </header>
